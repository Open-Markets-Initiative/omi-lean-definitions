...
theorem encodeBody_length_lt (message : ServerTcpMessage) : (encodeBody message).length + 2 < 65536 := by
  ...
  | mdInstrumentDefinitionFutureLegacy inner =>
    ...
    simp [encodeBody, h, ServerPayload.encode, MdInstrumentDefinitionFutureLegacy.encode, encodeMany_length_const EventsGroup.encode 9 EventsGroup.encode_length, encodeMany_length_const FeedTypesGroup.encode 4 FeedTypesGroup.encode_length, encodeMany_length_const InstAttribGroup.encode 4 InstAttribGroup.encode_length, encodeMany_length_const LotTypeRulesGroup.encode 5 LotTypeRulesGroup.encode_length]
    omega
  | mdInstrumentDefinitionSpreadLegacy inner =>
    ...
    simp [encodeBody, h, ServerPayload.encode, MdInstrumentDefinitionSpreadLegacy.encode, encodeMany_length_const EventsGroup.encode 9 EventsGroup.encode_length, encodeMany_length_const FeedTypesGroup.encode 4 FeedTypesGroup.encode_length, encodeMany_length_const InstAttribGroup.encode 4 InstAttribGroup.encode_length, encodeMany_length_const LotTypeRulesGroup.encode 5 LotTypeRulesGroup.encode_length, encodeMany_length_const LegacyLegsGroup.encode 18 LegacyLegsGroup.encode_length]
    omega
  ...
  | mdIncrementalRefreshBookLegacy inner =>
    ...
    simp [encodeBody, h, ServerPayload.encode, MdIncrementalRefreshBookLegacy.encode, encodeMany_length_const IncrementalRefreshBookGroup.encode 32 IncrementalRefreshBookGroup.encode_length, encodeMany_length_const IncrementalRefreshBookOrderIdGroup.encode 24 IncrementalRefreshBookOrderIdGroup.encode_length]
    omega
  | mdIncrementalRefreshDailyStatisticsLegacy inner =>
    ...
    simp [encodeBody, h, ServerPayload.encode, MdIncrementalRefreshDailyStatisticsLegacy.encode, encodeMany_length_const IncrementalRefreshDailyStatisticsGroup.encode 32 IncrementalRefreshDailyStatisticsGroup.encode_length]
    omega
  | mdIncrementalRefreshLimitsBandingLegacy inner =>
    ...
    simp [encodeBody, h, ServerPayload.encode, MdIncrementalRefreshLimitsBandingLegacy.encode, encodeMany_length_const IncrementalRefreshLimitsBandingGroup.encode 32 IncrementalRefreshLimitsBandingGroup.encode_length]
    omega
  | mdIncrementalRefreshSessionStatisticsLegacy inner =>
    ...
    simp [encodeBody, h, ServerPayload.encode, MdIncrementalRefreshSessionStatisticsLegacy.encode, encodeMany_length_const IncrementalRefreshSessionStatisticsGroup.encode 24 IncrementalRefreshSessionStatisticsGroup.encode_length]
    omega
  ...
  | snapshotFullRefreshLegacy inner =>
    ...
    simp [encodeBody, h, ServerPayload.encode, SnapshotFullRefreshLegacy.encode, encodeMany_length_const SnapshotFullRefreshGroup.encode 22 SnapshotFullRefreshGroup.encode_length]
    omega
  | quoteRequest inner =>
  ...
  | mdInstrumentDefinitionOptionLegacy inner =>
    ...
    simp [encodeBody, h, ServerPayload.encode, MdInstrumentDefinitionOptionLegacy.encode, encodeMany_length_const EventsGroup.encode 9 EventsGroup.encode_length, encodeMany_length_const FeedTypesGroup.encode 4 FeedTypesGroup.encode_length, encodeMany_length_const InstAttribGroup.encode 4 InstAttribGroup.encode_length, encodeMany_length_const LotTypeRulesGroup.encode 5 LotTypeRulesGroup.encode_length, encodeMany_length_const OptionUnderlyingsGroup.encode 24 OptionUnderlyingsGroup.encode_length, encodeMany_length_const OptionRelatedInstrumentsGroup.encode 24 OptionRelatedInstrumentsGroup.encode_length]
    omega
  ...
  | mdIncrementalRefreshOrderBookLegacy inner =>
    ...
    simp [encodeBody, h, ServerPayload.encode, MdIncrementalRefreshOrderBookLegacy.encode, encodeMany_length_const IncrementalRefreshOrderBookGroup.encode 40 IncrementalRefreshOrderBookGroup.encode_length]
    omega
  | snapshotFullRefreshOrderBookLegacy inner =>
    ...
    simp [encodeBody, h, ServerPayload.encode, SnapshotFullRefreshOrderBookLegacy.encode, encodeMany_length_const SnapshotFullRefreshOrderBookGroup.encode 29 SnapshotFullRefreshOrderBookGroup.encode_length]
    omega
