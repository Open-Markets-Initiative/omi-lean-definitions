...
theorem encodeBody_length_lt (message : ServerTcpMessage) : (encodeBody message).length + 2 < 65536 := by
  ...
  | mdInstrumentDefinitionRepo inner =>
    ...
    simp [encodeBody, h, ServerPayload.encode, MdInstrumentDefinitionRepo.encode, encodeMany_length_const EventsGroup.encode 9 EventsGroup.encode_length, encodeMany_length_const FeedTypesGroup.encode 4 FeedTypesGroup.encode_length, encodeMany_length_const InstAttribGroup.encode 4 InstAttribGroup.encode_length, encodeMany_length_const LotTypeRulesGroup.encode 5 LotTypeRulesGroup.encode_length, encodeMany_length_const RepoUnderlyingsGroup.encode 118 RepoUnderlyingsGroup.encode_length, encodeMany_length_const RepoRelatedInstrumentsGroup.encode 32 RepoRelatedInstrumentsGroup.encode_length]
    omega
