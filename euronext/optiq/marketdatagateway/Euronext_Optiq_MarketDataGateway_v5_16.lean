...
/-!
# Euronext Market Data Gateway v5.16
...
namespace Omi.EuronextOptiqMarketdatagatewaySbeV516
...
/-- The most bytes an encoding can take -/
theorem encode_length_le (message : StandingDataMessage) : (encode message).length ≤ 4497 := by
...
end Omi.EuronextOptiqMarketdatagatewaySbeV516
