        ...
        if fits_lotTypeRulesGroup : lotTypeRulesGroup_.length < 256 then
          if fits_repoUnderlyingsGroup : repoUnderlyingsGroup_.length < 256 then
            if fits_repoRelatedInstrumentsGroup : repoRelatedInstrumentsGroup_.length < 256 then
              pure ({ matchEventIndicator, totNumReportsOptional, securityUpdateAction, lastUpdateTime, mdSecurityTradingStatus, applId, marketSegmentId, underlyingProduct, securityExchange, securityGroup, asset, symbol, securityId, securityType, cfiCode, currency, settlCurrency, matchAlgorithm, minTradeVol, maxTradeVol, minPriceIncrementEx, displayFactor, unitOfMeasure, unitOfMeasureQty, tradingReferencePrice, tradingReferenceDate, highLimitPrice, lowLimitPrice, maxPriceVariation, financialInstrumentFullName, partyRoleClearingOrg, startDate, endDate, terminationType, repoSubType, moneyOrPar, maxNoOfSubstitutions, priceQuoteMethod, userDefinedInstrument, riskSet, marketSet, instrumentGuid, termCode, blockLength, eventsGroup := ⟨eventsGroup_, fits_eventsGroup⟩, blockLength, feedTypesGroup := ⟨feedTypesGroup_, fits_feedTypesGroup⟩, blockLength, instAttribGroup := ⟨instAttribGroup_, fits_instAttribGroup⟩, blockLength, lotTypeRulesGroup := ⟨lotTypeRulesGroup_, fits_lotTypeRulesGroup⟩, blockLength, repoUnderlyingsGroup := ⟨repoUnderlyingsGroup_, fits_repoUnderlyingsGroup⟩, blockLength, repoRelatedInstrumentsGroup := ⟨repoRelatedInstrumentsGroup_, fits_repoRelatedInstrumentsGroup⟩ }, bytes)
            else none
          else none
        else none
      else none
      ...
      if fits_instAttribGroup : instAttribGroup_.length < 256 then
        if fits_fxLotTypeRulesGroup : fxLotTypeRulesGroup_.length < 256 then
          if fits_tradingSessionsGroup : tradingSessionsGroup_.length < 256 then
            pure ({ matchEventIndicator, totNumReportsOptional, securityUpdateAction, lastUpdateTime, mdSecurityTradingStatus, applId, marketSegmentId, underlyingProduct, securityExchange, securityGroup, asset, symbol, securityId, securityType, cfiCode, currency, settlCurrency, priceQuoteCurrency, matchAlgorithm, minTradeVol, maxTradeVol, minPriceIncrementEx, displayFactor, pricePrecision, unitOfMeasure, unitOfMeasureQty, highLimitPrice, lowLimitPrice, maxPriceVariation, userDefinedInstrument, financialInstrumentFullName, fxCurrencySymbol, settlType, interveningDays, fxBenchmarkRateFix, rateSource, fixRateLocalTime, fixRateLocalTimeZone, minQuoteLife, maxPriceDiscretionOffset, instrumentGuid, maturityMonthYear, settlementLocale, blockLength, eventsGroup := ⟨eventsGroup_, fits_eventsGroup⟩, blockLength, feedTypesGroup := ⟨feedTypesGroup_, fits_feedTypesGroup⟩, blockLength, instAttribGroup := ⟨instAttribGroup_, fits_instAttribGroup⟩, blockLength, fxLotTypeRulesGroup := ⟨fxLotTypeRulesGroup_, fits_fxLotTypeRulesGroup⟩, blockLength, tradingSessionsGroup := ⟨tradingSessionsGroup_, fits_tradingSessionsGroup⟩ }, bytes)
          else none
        else none
      else none
    else none
...
theorem encodeBody_length_lt (message : Message) : (encodeBody message).length + 2 < 65536 := by
  ...
  | mdInstrumentDefinitionFixedIncome inner =>
    ...
    simp [encodeBody, h, Payload.encode, MdInstrumentDefinitionFixedIncome.encode, encodeMany_length_const EventsGroup.encode 9 EventsGroup.encode_length, encodeMany_length_const FeedTypesGroup.encode 4 FeedTypesGroup.encode_length, encodeMany_length_const InstAttribGroup.encode 4 InstAttribGroup.encode_length, encodeMany_length_const LotTypeRulesGroup.encode 5 LotTypeRulesGroup.encode_length]
    omega
  | mdInstrumentDefinitionRepo inner =>
    ...
    simp [encodeBody, h, Payload.encode, MdInstrumentDefinitionRepo.encode, encodeMany_length_const EventsGroup.encode 9 EventsGroup.encode_length, encodeMany_length_const FeedTypesGroup.encode 4 FeedTypesGroup.encode_length, encodeMany_length_const InstAttribGroup.encode 4 InstAttribGroup.encode_length, encodeMany_length_const LotTypeRulesGroup.encode 5 LotTypeRulesGroup.encode_length, encodeMany_length_const RepoUnderlyingsGroup.encode 118 RepoUnderlyingsGroup.encode_length, encodeMany_length_const RepoRelatedInstrumentsGroup.encode 32 RepoRelatedInstrumentsGroup.encode_length]
    omega
  | snapshotRefreshTopOrders inner =>
    ...
    simp [encodeBody, h, Payload.encode, SnapshotRefreshTopOrders.encode, encodeMany_length_const SnapshotRefreshTopOrdersGroup.encode 29 SnapshotRefreshTopOrdersGroup.encode_length]
    omega
  | securityStatusWorkup inner =>
    ...
    simp [encodeBody, h, Payload.encode, SecurityStatusWorkup.encode, encodeMany_length_const SecurityStatusWorkupGroup.encode 10 SecurityStatusWorkupGroup.encode_length]
    omega
  | snapshotFullRefreshTcp inner =>
    ...
    simp [encodeBody, h, Payload.encode, SnapshotFullRefreshTcp.encode, encodeMany_length_const SnapshotFullRefreshTcpGroup.encode 26 SnapshotFullRefreshTcpGroup.encode_length]
    omega
  | collateralMarketValue inner =>
    ...
    simp [encodeBody, h, Payload.encode, CollateralMarketValue.encode, encodeMany_length_const CollateralMarketValueGroup.encode 40 CollateralMarketValueGroup.encode_length]
    omega
  | mdInstrumentDefinitionFx inner =>
    ...
    simp [encodeBody, h, Payload.encode, MdInstrumentDefinitionFx.encode, encodeMany_length_const EventsGroup.encode 9 EventsGroup.encode_length, encodeMany_length_const FeedTypesGroup.encode 4 FeedTypesGroup.encode_length, encodeMany_length_const InstAttribGroup.encode 4 InstAttribGroup.encode_length, encodeMany_length_const FxLotTypeRulesGroup.encode 9 FxLotTypeRulesGroup.encode_length, encodeMany_length_const TradingSessionsGroup.encode 18 TradingSessionsGroup.encode_length]
    omega
  | mdIncrementalRefreshBookLongQty inner =>
    ...
    simp [encodeBody, h, Payload.encode, MdIncrementalRefreshBookLongQty.encode, encodeMany_length_const IncrementalRefreshBookLongGroup.encode 32 IncrementalRefreshBookLongGroup.encode_length, encodeMany_length_const IncrementalRefreshBookLongOrderIdGroup.encode 24 IncrementalRefreshBookLongOrderIdGroup.encode_length]
    omega
  | mdIncrementalRefreshTradeSummaryLongQty inner =>
    ...
    simp [encodeBody, h, Payload.encode, MdIncrementalRefreshTradeSummaryLongQty.encode, encodeMany_length_const IncrementalRefreshTradeSummaryLongGroup.encode 40 IncrementalRefreshTradeSummaryLongGroup.encode_length, encodeMany_length_const IncrementalRefreshTradeSummaryLongOrderIdGroup.encode 16 IncrementalRefreshTradeSummaryLongOrderIdGroup.encode_length]
    omega
  | mdIncrementalRefreshVolumeLongQty inner =>
    ...
    simp [encodeBody, h, Payload.encode, MdIncrementalRefreshVolumeLongQty.encode, encodeMany_length_const IncrementalRefreshVolumeLongGroup.encode 24 IncrementalRefreshVolumeLongGroup.encode_length]
    omega
  | mdIncrementalRefreshSessionStatisticsLongQty inner =>
    ...
    simp [encodeBody, h, Payload.encode, MdIncrementalRefreshSessionStatisticsLongQty.encode, encodeMany_length_const IncrementalRefreshSessionStatisticsLongGroup.encode 32 IncrementalRefreshSessionStatisticsLongGroup.encode_length]
    omega
  | snapshotFullRefreshTcpLongQty inner =>
    ...
    simp [encodeBody, h, Payload.encode, SnapshotFullRefreshTcpLongQty.encode, encodeMany_length_const SnapshotfullRefreshTcpLongGroup.encode 23 SnapshotfullRefreshTcpLongGroup.encode_length]
    omega
  | snapshotFullRefreshLongQty inner =>
    ...
    simp [encodeBody, h, Payload.encode, SnapshotFullRefreshLongQty.encode, encodeMany_length_const SnapshotFullRefreshLongGroup.encode 23 SnapshotFullRefreshLongGroup.encode_length]
    omega
  | negotiate inner =>
