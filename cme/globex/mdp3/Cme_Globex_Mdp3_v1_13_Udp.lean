...
@[simp] theorem decode_encode (message : RepoUnderlyingsGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 RepoUnderlyingsGroup.encode RepoUnderlyingsGroup.decode RepoUnderlyingsGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : RepoRelatedInstrumentsGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 RepoRelatedInstrumentsGroup.encode RepoRelatedInstrumentsGroup.decode RepoRelatedInstrumentsGroup.decode_encode, Option.bind_some]
  dsimp only
...
theorem encode_length_le (message : BrokenDatesGroups) : (encode message).length ≤ 4083 := by
  ...
  unfold encode
  simp only [List.length_append, encodeUIntLE_length, encodeUInt_length, encodeMany_length_const BrokenDatesGroup.encode 16 BrokenDatesGroup.encode_length]
  omega
...
@[simp] theorem decode_encode (message : BrokenDatesGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 BrokenDatesGroup.encode BrokenDatesGroup.decode BrokenDatesGroup.decode_encode, Option.bind_some]
  dsimp only
  simp only [message.brokenDatesGroup.length_lt, ↓reduceDIte]
  rfl
...
@[simp] theorem decode_encode (message : MdInstrumentDefinitionRepo) (rest : List UInt8) :
  ...
  rw [LotTypeRulesGroups.decode_encode, Option.bind_some]
  dsimp only
  rw [RepoUnderlyingsGroups.decode_encode, Option.bind_some]
  dsimp only
  rw [RepoRelatedInstrumentsGroups.decode_encode, Option.bind_some]
  dsimp only
  rw [BrokenDatesGroups.decode_encode, Option.bind_some]
  rfl
...
@[simp] theorem decode_encode (message : SnapshotRefreshTopOrdersGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 SnapshotRefreshTopOrdersGroup.encode SnapshotRefreshTopOrdersGroup.decode SnapshotRefreshTopOrdersGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : SecurityStatusWorkupGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 SecurityStatusWorkupGroup.encode SecurityStatusWorkupGroup.decode SecurityStatusWorkupGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : SnapshotFullRefreshTcpGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 SnapshotFullRefreshTcpGroup.encode SnapshotFullRefreshTcpGroup.decode SnapshotFullRefreshTcpGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : CollateralMarketValueGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 CollateralMarketValueGroup.encode CollateralMarketValueGroup.decode CollateralMarketValueGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : FxLotTypeRulesGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 FxLotTypeRulesGroup.encode FxLotTypeRulesGroup.decode FxLotTypeRulesGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : TradingSessionsGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 TradingSessionsGroup.encode TradingSessionsGroup.decode TradingSessionsGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : MdInstrumentDefinitionFx) (rest : List UInt8) :
  ...
  rw [InstAttribGroups.decode_encode, Option.bind_some]
  dsimp only
  rw [FxLotTypeRulesGroups.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : IncrementalRefreshBookLongGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 IncrementalRefreshBookLongGroup.encode IncrementalRefreshBookLongGroup.decode IncrementalRefreshBookLongGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : IncrementalRefreshBookLongOrderIdGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 IncrementalRefreshBookLongOrderIdGroup.encode IncrementalRefreshBookLongOrderIdGroup.decode IncrementalRefreshBookLongOrderIdGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : MdIncrementalRefreshBookLongQty) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode, Option.bind_some]
  dsimp only
  rw [IncrementalRefreshBookLongGroups.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : IncrementalRefreshTradeSummaryLongGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 IncrementalRefreshTradeSummaryLongGroup.encode IncrementalRefreshTradeSummaryLongGroup.decode IncrementalRefreshTradeSummaryLongGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : IncrementalRefreshTradeSummaryLongOrderIdGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 IncrementalRefreshTradeSummaryLongOrderIdGroup.encode IncrementalRefreshTradeSummaryLongOrderIdGroup.decode IncrementalRefreshTradeSummaryLongOrderIdGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : MdIncrementalRefreshTradeSummaryLongQty) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode, Option.bind_some]
  dsimp only
  rw [IncrementalRefreshTradeSummaryLongGroups.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : IncrementalRefreshVolumeLongGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 IncrementalRefreshVolumeLongGroup.encode IncrementalRefreshVolumeLongGroup.decode IncrementalRefreshVolumeLongGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : IncrementalRefreshSessionStatisticsLongGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 IncrementalRefreshSessionStatisticsLongGroup.encode IncrementalRefreshSessionStatisticsLongGroup.decode IncrementalRefreshSessionStatisticsLongGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : SnapshotfullRefreshTcpLongGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 SnapshotfullRefreshTcpLongGroup.encode SnapshotfullRefreshTcpLongGroup.decode SnapshotfullRefreshTcpLongGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : SnapshotFullRefreshLongGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 SnapshotFullRefreshLongGroup.encode SnapshotFullRefreshLongGroup.decode SnapshotFullRefreshLongGroup.decode_encode, Option.bind_some]
  dsimp only
