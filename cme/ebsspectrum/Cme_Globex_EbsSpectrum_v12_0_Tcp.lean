...
@[simp] theorem decode_encode (message : IncrementalRefreshSpectrumGroup) (rest : List UInt8) :
  ...
  unfold decode encode
  simp only [List.append_assoc, Option.bind_eq_bind]
  rw [MdEntryTypeSpectrumEntryType.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : IncrementalRefreshSpectrumGroups) (rest : List UInt8) :
  ...
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 IncrementalRefreshSpectrumGroup.encode IncrementalRefreshSpectrumGroup.decode IncrementalRefreshSpectrumGroup.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : IncrementalRefreshTickerGroup) (rest : List UInt8) :
  ...
  unfold decode encode
  simp only [List.append_assoc, Option.bind_eq_bind]
  rw [MdEntryTypeTickerEntryType.decode_encode]
  simp only [Option.bind_some]
  rw [decodeUIntLE_encodeUIntLE]
  simp only [Option.bind_some]
  rw [Alpha.decode_encode]
...
@[simp] theorem decode_encode (message : IncrementalRefreshTickerGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 IncrementalRefreshTickerGroup.encode IncrementalRefreshTickerGroup.decode IncrementalRefreshTickerGroup.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : SnapshotRefreshSpectrumGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 SnapshotRefreshSpectrumGroup.encode SnapshotRefreshSpectrumGroup.decode SnapshotRefreshSpectrumGroup.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : SnapshotRefreshTickerGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 SnapshotRefreshTickerGroup.encode SnapshotRefreshTickerGroup.decode SnapshotRefreshTickerGroup.decode_encode]
  simp only [Option.bind_some]
