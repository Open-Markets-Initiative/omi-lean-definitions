...
@[simp] theorem decode_encode (message : TesApproveBroadcast) (rest : List UInt8) :
  ...
  dsimp only
  simp only [message.instrumentEventGrpComp.length_lt, message.instrumentAttributeGrpComp.length_lt, message.underlyingStipGrpComp.length_lt, ↓reduceDIte]
  rfl
...
@[simp] theorem decode_encode (message : TesBroadcast) (rest : List UInt8) :
  ...
  rw [decodeMany_bounded 1 UnderlyingStipGrpComp.encode UnderlyingStipGrpComp.decode UnderlyingStipGrpComp.decode_encode, Option.bind_some]
  dsimp only
  simp only [message.sideAllocGrpBcComp.length_lt, message.instrumentEventGrpComp.length_lt, message.instrumentAttributeGrpComp.length_lt, message.underlyingStipGrpComp.length_lt, ↓reduceDIte]
  rfl
