...
@[simp] theorem decode_encode (message : EnterTesTradeRequest) (rest : List UInt8) :
  ...
  dsimp only
  rw [dite_eq_left message.sideAllocGrpComp.length_lt, dite_eq_left message.instrumentEventGrpComp.length_lt, dite_eq_left message.instrumentAttributeGrpComp.length_lt, dite_eq_left message.underlyingStipGrpComp.length_lt]
  rfl
