...
/-!
# Euronext Market Data Gateway v4.2
...
namespace Omi.EuronextOptiqMarketdatagatewaySbeV42
...
/-- Full Trade Information Message: 406 bytes -/
...
/-- The most bytes an encoding can take -/
theorem encode_length_le (message : StandingDataMessage) : (encode message).length ≤ 4491 := by
...
end Omi.EuronextOptiqMarketdatagatewaySbeV42
