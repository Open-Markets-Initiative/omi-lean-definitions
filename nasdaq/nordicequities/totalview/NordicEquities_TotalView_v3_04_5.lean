...
/-!
# National Association of Securities Dealers Automated Quotations (Nasdaq) Nordic Equity TotalView v3.04.5
...
namespace Omi.NasdaqNordicequitiesTotalviewItchV3045
...
theorem encode_length_le (message : Payload) : (encode message).length ≤ 96 := by
  cases message with
...
end Omi.NasdaqNordicequitiesTotalviewItchV3045
