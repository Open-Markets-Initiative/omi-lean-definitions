...
/-!
# Euronext Market Data Gateway v6.67
...
namespace Omi.EuronextOptiqMarketdatagatewaySbeV667
...
def ExchangeCode.codes : List UInt8 :=
  [0x41, 0x42, 0x43, 0x44, 0x46, 0x47, 0x48, 0x4A, 0x4B, 0x4D, 0x50, 0x52, 0x53, 0x59, 0x5A, 0x4E, 0x4F, 0x4C, 0x55, 0x49, 0x45, 0x54, 0x56]
...
def listed (byte : UInt8) : ExchangeCode :=
  ...
  else .euronextAmsterdamOtherCommodities
...
end Omi.EuronextOptiqMarketdatagatewaySbeV667
