...
@[simp] theorem decode_encode (message : ApproveBasketTradeRequest) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 2 BasketSideAllocExtGrpComp.encode BasketSideAllocExtGrpComp.decode BasketSideAllocExtGrpComp.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : BasketRollRequest) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [OldBasketDataGrpComp.decode_encode]
  simp only [Option.bind_some]
  rw [NewBasketDataGrpComp.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 BasketRootPartyGrpComp.encode BasketRootPartyGrpComp.decode BasketRootPartyGrpComp.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : MassOrder) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 OrderEntryGrpComp.encode OrderEntryGrpComp.decode OrderEntryGrpComp.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : SrqsHitQuoteRequest) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 SrqsHitQuoteGrpComp.encode SrqsHitQuoteGrpComp.decode SrqsHitQuoteGrpComp.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : UpdateRemainingRiskAllowanceBaseRequest) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 2 RraUpdateBasePartyGrpComp.encode RraUpdateBasePartyGrpComp.decode RraUpdateBasePartyGrpComp.decode_encode]
  simp only [Option.bind_some]
