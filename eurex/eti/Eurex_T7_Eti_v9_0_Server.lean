...
@[simp] theorem decode_encode (message : BasketApproveBroadcast) (rest : List UInt8) :
  ...
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 BasketSideAllocExtBcGrpComp.encode BasketSideAllocExtBcGrpComp.decode BasketSideAllocExtBcGrpComp.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : BasketBroadcast) (rest : List UInt8) :
  ...
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 BasketSideAllocGrpComp.encode BasketSideAllocGrpComp.decode BasketSideAllocGrpComp.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : TesTradeBroadcast) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 SrqsRelatedTradeIdGrpComp.encode SrqsRelatedTradeIdGrpComp.decode SrqsRelatedTradeIdGrpComp.decode_encode]
  simp only [Option.bind_some]
