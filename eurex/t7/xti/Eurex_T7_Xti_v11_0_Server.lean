...
/-!
# Eurex Exchange Cash Enhanced Trading Interface v11.0
...
namespace Omi.EurexT7XtiFbeV110Server
...
def decode (bytes : List UInt8) : Option (RiskLimitsRptGrpComp × List UInt8) := do
  ...
  let (pad2, bytes) ← Alpha.decode 2 bytes
  pure ({ riskLimitAmount, riskLimitOpenAmount, riskLimitNetPositionAmount, riskLimitType, riskLimitRequestingPartyRole, riskLimitViolationIndicator, riskLimitGroup, pad2 }, bytes)
...
end Omi.EurexT7XtiFbeV110Server
