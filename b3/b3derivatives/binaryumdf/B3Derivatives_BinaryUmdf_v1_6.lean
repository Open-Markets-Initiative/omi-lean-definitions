...
/-!
# Brasil, Bolsa, Balcão Binary Unified Market Data Feed v1.6
...
namespace Omi.B3B3derivativesBinaryumdfSbeV16
...
def decode (bytes : List UInt8) : Option (DeprecatedSecurityDefinitionMessage × List UInt8) := do
  ...
  pure ({ securityId, securityExchange, securityIdSource, securityGroup, symbol, securityUpdateAction, securityType, securitySubType, totNoRelatedSym, minPriceIncrement, strikePrice, contractMultiplier, priceDivisor, securityValidityTimestamp, noSharesIssued, clearingHouseId, minOrderQty, maxOrderQty, minLotSize, minTradeVol, corporateActionEventId, issueDate, maturityDate, countryOfIssue, startDate, endDate, settlType, settlDate, datedDate, isinNumber, asset, cfiCode, maturityMonthYear, contractSettlMonth, currency, strikeCurrency, settlCurrency, securityStrategyType, lotType, tickSizeDenominator, product, exerciseStyle, putOrCall, priceType, marketSegmentId, governanceIndicator, securityMatchType, lastFragment, multiLegModel, multiLegPriceMethod, minCrossQty, deprecatedUnderlyingsGroups, deprecatedLegsGroups, deprecatedInstrAttribsGroups, securityDesc }, bytes)
...
end Omi.B3B3derivativesBinaryumdfSbeV16
