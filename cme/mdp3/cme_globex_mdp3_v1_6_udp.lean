...
namespace Omi.CmeGlobexMdp3SbeV16Udp
...
theorem encodeBody_length_lt (message : Message) : (encodeBody message).length + 2 < 65536 := by
  ...
  | mdIncrementalRefreshBook inner =>
    ...
    simp [encodeBody, h, Payload.encode, MdIncrementalRefreshBook.encode, encodeMany_length_const IncrementalRefreshBookGroup.encode 32 IncrementalRefreshBookGroup.encode_length]
    omega
...
end Omi.CmeGlobexMdp3SbeV16Udp
