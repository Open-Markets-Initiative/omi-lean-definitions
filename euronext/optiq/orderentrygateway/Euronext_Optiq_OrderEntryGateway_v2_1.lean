...
/-!
# Euronext Order Entry Gateway v2.1
...
namespace Omi.EuronextOptiqOrderentrygatewaySbeV21
...
/-- The most bytes an encoding can take -/
theorem encode_length_le (message : FillMessage) : (encode message).length ≤ 21275 := by
...
end Omi.EuronextOptiqOrderentrygatewaySbeV21
