...
namespace Omi.TmxTsxQuantumfeedlevel2XmtV36
...
@[simp] theorem encode_length (message : OrderBookMessage) : (encode message).length = 49 := by
  unfold encode
...
/-- Order Book Terms Message: 49 bytes -/
...
@[simp] theorem encode_length (message : OrderBookTermsMessage) : (encode message).length = 49 := by
  unfold encode
  simp only [List.length_append, Alpha.encode_length, encodeUIntLE_length, OrderSide.encode_length, NonResident.encode_length, SettlementTerms.encode_length]
...
/-- Assign Cop Orders Message: 179 bytes -/
...
@[simp] theorem encode_length (message : AssignCopOrdersMessage) : (encode message).length = 179 := by
  unfold encode
...
/-- Assign Cop No Orders Message: 28 bytes -/
...
@[simp] theorem encode_length (message : AssignCopNoOrdersMessage) : (encode message).length = 28 := by
  unfold encode
...
/-- Assign Limit Message: 299 bytes -/
...
@[simp] theorem encode_length (message : AssignLimitMessage) : (encode message).length = 299 := by
  unfold encode
...
/-- Moc Imbalance Message: 58 bytes -/
...
@[simp] theorem encode_length (message : MocImbalanceMessage) : (encode message).length = 58 := by
  unfold encode
...
/-- Order Booked Terms Message: 57 bytes -/
...
@[simp] theorem encode_length (message : OrderBookedTermsMessage) : (encode message).length = 57 := by
  unfold encode
  simp only [List.length_append, Alpha.encode_length, encodeUIntLE_length, OrderSide.encode_length, NonResident.encode_length, SettlementTerms.encode_length]
...
/-- Order Cancelled Terms Message: 31 bytes -/
...
@[simp] theorem encode_length (message : OrderCancelledTermsMessage) : (encode message).length = 31 := by
  unfold encode
  simp only [List.length_append, Alpha.encode_length, encodeUIntLE_length, OrderSide.encode_length]
...
/-- Order Price Time Assigned Terms Message: 51 bytes -/
...
@[simp] theorem encode_length (message : OrderPriceTimeAssignedTermsMessage) : (encode message).length = 51 := by
  unfold encode
  simp only [List.length_append, Alpha.encode_length, encodeUIntLE_length, OrderSide.encode_length]
...
@[simp] theorem encode_length (message : StockStatusMessage) : (encode message).length = 64 := by
  unfold encode
...
def decode (bytes : List UInt8) : Option (TradeReportMessage × List UInt8) := do
  ...
  pure ({ symbol, tradeNumber, price, volume, buyBrokerNumber, buyOrderId, buyDisplayVolume, sellBrokerNumber, sellOrderId, sellDisplayVolume, bypass, tradeTimeStamp, crossType, tradingSystemTimeStamp, listingMarket, productType, tradeDate, isMidOnly, isDark, isConditional }, bytes)

@[simp] theorem encode_length (message : TradeReportMessage) : (encode message).length = 79 := by
  unfold encode
  simp only [List.length_append, Alpha.encode_length, encodeUIntLE_length, Bypass.encode_length, CrossType.encode_length, ListingMarket.encode_length, ProductType.encode_length, IsMidOnly.encode_length, IsDark.encode_length, IsConditional.encode_length]
...
/-- Trade Report Terms Message: 75 bytes -/
...
@[simp] theorem encode_length (message : TradeReportTermsMessage) : (encode message).length = 75 := by
  unfold encode
...
/-- Trade Cancelled Message: 30 bytes -/
...
@[simp] theorem encode_length (message : TradeCancelledMessage) : (encode message).length = 30 := by
  unfold encode
  simp only [List.length_append, Alpha.encode_length, encodeUIntLE_length, ListingMarket.encode_length, ProductType.encode_length]
...
/-- Trade Correction Message: 60 bytes -/
...
@[simp] theorem encode_length (message : TradeCorrectionMessage) : (encode message).length = 60 := by
  unfold encode
...
/-- Trade Correction Terms Message: 56 bytes -/
...
@[simp] theorem encode_length (message : TradeCorrectionTermsMessage) : (encode message).length = 56 := by
  unfold encode
...
theorem encode_length_le (message : BusinessMessage) : (encode message).length ≤ 299 := by
  cases message with
...
end Omi.TmxTsxQuantumfeedlevel2XmtV36
