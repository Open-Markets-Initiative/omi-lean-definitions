...
/-!
# Euronext Order Entry Gateway v4.11
...
namespace Omi.EuronextOptiqOrderentrygatewaySbeV411
...
/-- The most bytes an encoding can take -/
theorem encode_length_le (message : NewOrderMessage) : (encode message).length ≤ 33238 := by
...
end Omi.EuronextOptiqOrderentrygatewaySbeV411
