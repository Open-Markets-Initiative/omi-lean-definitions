...
theorem encode_length_le (message : OutrightTradeEventsGroups) : (encode message).length ≤ 5868 := by
  ...
  unfold encode
  simp only [List.length_append, encodeUIntLE_length, encodeUInt_length, encodeMany_length_const OutrightTradeEventsGroup.encode 23 OutrightTradeEventsGroup.encode_length]
  omega
...
theorem encode_length_le (message : SpreadTradeEventsGroups) : (encode message).length ≤ 5868 := by
  ...
  unfold encode
  simp only [List.length_append, encodeUIntLE_length, encodeUInt_length, encodeMany_length_const SpreadTradeEventsGroup.encode 23 SpreadTradeEventsGroup.encode_length]
  omega
...
theorem encode_length_le (message : SpreadLegTradeEventsGroups) : (encode message).length ≤ 5868 := by
  ...
  unfold encode
  simp only [List.length_append, encodeUIntLE_length, encodeUInt_length, encodeMany_length_const SpreadLegTradeEventsGroup.encode 23 SpreadLegTradeEventsGroup.encode_length]
  omega
