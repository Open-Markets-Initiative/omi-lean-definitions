...
namespace Omi.EurexT7XtiFbeV121Client
...
/-- Modify Order Request: 250 bytes -/
...
/-- Modify Order Short Request: 114 bytes -/
...
/-- New Order Short Request: 106 bytes -/
...
@[simp] theorem encode_length (message : NewOrderShortRequest) : (encode message).length = 106 := by
  unfold encode
  simp only [List.length_append, Alpha.encode_length, RequestHeaderComp.encode_length, encodeUIntLE_length, encodeUInt_length]
...
/-- New Order Single Request: 234 bytes -/
...
end Omi.EurexT7XtiFbeV121Client
