...
namespace Omi.NasdaqNomoptionsIttoItchV40ServerTcp
...
theorem encode_length_le (message : SequencedMessage) : (encode message).length ≤ 56 := by
  cases message with
...
theorem encode_length_le (message : SequencedDataPacket) : (encode message).length ≤ 57 := by
  unfold encode
  ...
  | tradingActionMessage inner =>
    ...
    omega
  | securityOpenMessage inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, SecurityOpenMessage.encode_length]
    omega
  | addOrderMessageShortMessageForm inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, AddOrderMessageShortMessageForm.encode_length]
    omega
  | addOrderMessageLongFormMessage inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, AddOrderMessageLongFormMessage.encode_length]
    omega
  | addQuoteMessageShortFormMessage inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, AddQuoteMessageShortFormMessage.encode_length]
    omega
  | addQuoteMessageLongFormMessage inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, AddQuoteMessageLongFormMessage.encode_length]
    omega
  | singleSideExecutedMessage inner =>
  ...
  | orderCancelMessage inner =>
    ...
    omega
  | singleSideReplaceMessageShortForm inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, SingleSideReplaceMessageShortForm.encode_length]
    omega
  | singleSideReplaceMessageLongForm inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, SingleSideReplaceMessageLongForm.encode_length]
    omega
  | singleSideDeleteMessage inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, SingleSideDeleteMessage.encode_length]
    omega
  | singleSideChangeMessage inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, SingleSideChangeMessage.encode_length]
    omega
  | quoteReplaceMessageShortForm inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, QuoteReplaceMessageShortForm.encode_length]
    omega
  | quoteReplaceMessageLongForm inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, QuoteReplaceMessageLongForm.encode_length]
    omega
  | quoteDeleteMessage inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, QuoteDeleteMessage.encode_length]
    omega
  | optionsTradeMessagesNonAuction inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, OptionsTradeMessagesNonAuction.encode_length]
    omega
  | optionsCrossTradeMessage inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, OptionsCrossTradeMessage.encode_length]
    omega
  | brokenTradeOrderExecutedMessage inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, BrokenTradeOrderExecutedMessage.encode_length]
    omega
  | noiiMessage inner =>
    simp only [SequencedMessage.encode, List.length_append, encodeUInt_length, NoiiMessage.encode_length]
    omega
...
/-- The most bytes any message's encoding can take -/
theorem encode_length_le (message : ServerTcpPayload) : (encode message).length ≤ 57 := by
  cases message with
  | debugPacket inner =>
...
end Omi.NasdaqNomoptionsIttoItchV40ServerTcp
