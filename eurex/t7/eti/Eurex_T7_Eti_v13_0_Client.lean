...
namespace Omi.EurexT7EtiFbeV130Client
...
theorem encode_length_le (message : BasketRollRequest) : (encode message).length ≤ 4245410 := by
  ...
  unfold encode
  simp only [List.length_append, Alpha.encode_length, RequestHeaderComp.encode_length, encodeUIntLE_length, encodeUInt_length, encodeMany_length_const BasketRootPartyGrpComp.encode 40 BasketRootPartyGrpComp.encode_length, OldBasketDataGrpComp.encode_length, NewBasketDataGrpComp.encode_length, encodeMany_length_const OldBasketInstrmtMatchSideGrpComp.encode 80 OldBasketInstrmtMatchSideGrpComp.encode_length, encodeMany_length_const NewBasketInstrmtMatchSideGrpComp.encode 80 NewBasketInstrmtMatchSideGrpComp.encode_length, encodeMany_length_const OldBasketSideAllocGrpComp.encode 32 OldBasketSideAllocGrpComp.encode_length, encodeMany_length_const NewBasketSideAllocGrpComp.encode 32 NewBasketSideAllocGrpComp.encode_length]
  omega
...
end Omi.EurexT7EtiFbeV130Client
