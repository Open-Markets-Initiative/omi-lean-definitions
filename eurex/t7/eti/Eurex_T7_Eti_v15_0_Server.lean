...
/-!
# Eurex Exchange Enhanced Trading Interface v15.0
...
Note: Basket Roll Broadcast is not framed: its length Body Len is not an integer it reads.
...
Note: Tes Inquire Boundary Prices Response is not framed: its length Body Len is not an integer it reads.
...
Note: Update Reference Prices Response is not framed: its length Body Len is not an integer it reads.
...
namespace Omi.EurexT7EtiFbeV150Server
...
@[simp] theorem decode_encode (message : BasketRollBroadcast) (rest : List UInt8) :
  ...
  rw [List.append_assoc, Alpha.decode_encode, some_bind]
  dsimp only
  rw [List.append_assoc, OldBasketDataBcGrpComp.decode_encode, some_bind]
  dsimp only
  rw [List.append_assoc, NewBasketDataBcGrpComp.decode_encode, some_bind]
  dsimp only
  rw [List.append_assoc, decodeMany_bounded 1 BasketRootPartyGrpComp.encode BasketRootPartyGrpComp.decode BasketRootPartyGrpComp.decode_encode, some_bind]
  dsimp only
  rw [List.append_assoc, decodeMany_bounded 1 OldBasketInstrmtMatchSideGrpComp.encode OldBasketInstrmtMatchSideGrpComp.decode OldBasketInstrmtMatchSideGrpComp.decode_encode, some_bind]
  dsimp only
  rw [List.append_assoc, decodeMany_bounded 1 NewBasketInstrmtMatchSideGrpComp.encode NewBasketInstrmtMatchSideGrpComp.decode NewBasketInstrmtMatchSideGrpComp.decode_encode, some_bind]
  dsimp only
  rw [List.append_assoc, decodeMany_bounded 2 OldBasketSideAllocGrpComp.encode OldBasketSideAllocGrpComp.decode OldBasketSideAllocGrpComp.decode_encode, some_bind]
  dsimp only
  rw [decodeMany_bounded 2 NewBasketSideAllocGrpComp.encode NewBasketSideAllocGrpComp.decode NewBasketSideAllocGrpComp.decode_encode, some_bind]
  dsimp only
  rw [dite_eq_left message.basketRootPartyGrpComp.length_lt, dite_eq_left message.oldBasketInstrmtMatchSideGrpComp.length_lt, dite_eq_left message.newBasketInstrmtMatchSideGrpComp.length_lt, dite_eq_left message.oldBasketSideAllocGrpComp.length_lt, dite_eq_left message.newBasketSideAllocGrpComp.length_lt]
  rfl

/-- Decoded as the whole of a frame: nothing follows -/
theorem decode_encode_nil (message : BasketRollBroadcast) : decode (encode message) = some (message, []) :=
  List.append_nil (encode message) ▸ decode_encode message []
...
theorem encode_length_le (message : ClipResponse) : (encode message).length ≤ 6202 := by
  ...
  unfold encode
  simp only [List.length_append, ← Nat.add_assoc, Alpha.encode_length, NrResponseHeaderMeComp.encode_length, encodeUIntLE_length, encodeUInt_length, encodeMany_length_const CrossRequestAckSideGrpComp.encode 24 CrossRequestAckSideGrpComp.encode_length]
  omega
...
theorem encode_length_le (message : InquireEnrichmentRuleIdListResponse) : (encode message).length ≤ 6815690 := by
  ...
  unfold encode
  simp only [List.length_append, ← Nat.add_assoc, Alpha.encode_length, ResponseHeaderComp.encode_length, encodeUIntLE_length, encodeMany_length_const EnrichmentRulesGrpComp.encode 104 EnrichmentRulesGrpComp.encode_length]
  omega
...
theorem encode_length_le (message : InquireMmParameterResponse) : (encode message).length ≤ 12306 := by
  ...
  unfold encode
  simp only [List.length_append, ← Nat.add_assoc, Alpha.encode_length, NrResponseHeaderMeComp.encode_length, encodeUIntLE_length, encodeUInt_length, encodeMany_length_const MmParameterGrpComp.encode 48 MmParameterGrpComp.encode_length]
  omega
...
def decode (bytes : List UInt8) : Option (RiskLimitsRptGrpComp × List UInt8) := do
  ...
  let (pad5, bytes) ← Alpha.decode 5 bytes
  pure ({ riskLimitQty, riskLimitOpenQty, riskLimitNetPositionQty, nettingCoefficient, activationDate, riskLimitType, riskLimitRequestingPartyRole, riskLimitViolationIndicator, riskLimitGroupStatus, riskLimitGroup, pad5 }, bytes)
...
/-- The most bytes an encoding can take -/
theorem encode_length_le (message : TesApproveBroadcast) : (encode message).length ≤ 94512 := by
...
/-- The most bytes an encoding can take -/
theorem encode_length_le (message : TesBroadcast) : (encode message).length ≤ 108656 := by
...
/-- Tes Inquire Boundary Prices Response: 50 bytes -/
structure TesInquireBoundaryPricesResponse where
  pad2 : Alpha 2
  responseHeaderComp : ResponseHeaderComp
  minBoundaryPrice : BitVec 64
  maxBoundaryPrice : BitVec 64
  marketSegmentId : BitVec 32
  pad4 : Alpha 4
  deriving DecidableEq, Repr

namespace TesInquireBoundaryPricesResponse

def encode (message : TesInquireBoundaryPricesResponse) : List UInt8 :=
  Alpha.encode message.pad2
    ++ (ResponseHeaderComp.encode message.responseHeaderComp
    ++ (encodeUIntLE 8 message.minBoundaryPrice
    ++ (encodeUIntLE 8 message.maxBoundaryPrice
    ++ (encodeUIntLE 4 message.marketSegmentId
    ++ (Alpha.encode message.pad4)))))

def decode (bytes : List UInt8) : Option (TesInquireBoundaryPricesResponse × List UInt8) := do
  let (pad2, bytes) ← Alpha.decode 2 bytes
  let (responseHeaderComp, bytes) ← ResponseHeaderComp.decode bytes
  let (minBoundaryPrice, bytes) ← decodeUIntLE 8 bytes
  let (maxBoundaryPrice, bytes) ← decodeUIntLE 8 bytes
  let (marketSegmentId, bytes) ← decodeUIntLE 4 bytes
  let (pad4, bytes) ← Alpha.decode 4 bytes
  pure ({ pad2, responseHeaderComp, minBoundaryPrice, maxBoundaryPrice, marketSegmentId, pad4 }, bytes)

@[simp] theorem encode_length (message : TesInquireBoundaryPricesResponse) : (encode message).length = 50 := by
  unfold encode
  simp only [List.length_append, Alpha.encode_length, ResponseHeaderComp.encode_length, encodeUIntLE_length]

theorem encode_length_pos (message : TesInquireBoundaryPricesResponse) : (encode message).length > 0 := by
  rw [encode_length]
  decide

@[simp] theorem decode_encode (message : TesInquireBoundaryPricesResponse) (rest : List UInt8) :
    decode (encode message ++ rest) = some (message, rest) := by
  unfold decode encode
  rw [List.append_assoc, Alpha.decode_encode, some_bind]
  dsimp only
...
/-- Decoded as the whole of a frame: nothing follows -/
theorem decode_encode_nil (message : TesInquireBoundaryPricesResponse) : decode (encode message) = some (message, []) :=
  List.append_nil (encode message) ▸ decode_encode message []

end TesInquireBoundaryPricesResponse
...
/-- The most bytes an encoding can take -/
theorem encode_length_le (message : TesUploadBroadcast) : (encode message).length ≤ 79810 := by
...
/-- Update Reference Prices Response: 26 bytes -/
structure UpdateReferencePricesResponse where
  pad2 : Alpha 2
  responseHeaderComp : ResponseHeaderComp
  deriving DecidableEq, Repr

namespace UpdateReferencePricesResponse

def encode (message : UpdateReferencePricesResponse) : List UInt8 :=
  Alpha.encode message.pad2
    ++ (ResponseHeaderComp.encode message.responseHeaderComp)

def decode (bytes : List UInt8) : Option (UpdateReferencePricesResponse × List UInt8) := do
  let (pad2, bytes) ← Alpha.decode 2 bytes
  let (responseHeaderComp, bytes) ← ResponseHeaderComp.decode bytes
  pure ({ pad2, responseHeaderComp }, bytes)

@[simp] theorem encode_length (message : UpdateReferencePricesResponse) : (encode message).length = 26 := by
  unfold encode
  simp only [List.length_append, Alpha.encode_length, ResponseHeaderComp.encode_length]

theorem encode_length_pos (message : UpdateReferencePricesResponse) : (encode message).length > 0 := by
  rw [encode_length]
  decide

@[simp] theorem decode_encode (message : UpdateReferencePricesResponse) (rest : List UInt8) :
    decode (encode message ++ rest) = some (message, rest) := by
  unfold decode encode
  rw [List.append_assoc, Alpha.decode_encode, some_bind]
  dsimp only
...
/-- Decoded as the whole of a frame: nothing follows -/
theorem decode_encode_nil (message : UpdateReferencePricesResponse) : decode (encode message) = some (message, []) :=
  List.append_nil (encode message) ▸ decode_encode message []

end UpdateReferencePricesResponse
...
inductive ServerPayload where
  ...
  | tesInquireBoundaryPricesResponse (message : TesInquireBoundaryPricesResponse) -- 10330
  ...
  | updateReferencePricesResponse (message : UpdateReferencePricesResponse) -- 10332
...
def tag : ServerPayload → BitVec 16
  ...
  | .tesInquireBoundaryPricesResponse _ => 10330
  | .tesResponse _ => 10611
  ...
  | .updateReferencePricesResponse _ => 10332
...
def encode : ServerPayload → List UInt8
  ...
  | .tesInquireBoundaryPricesResponse message => TesInquireBoundaryPricesResponse.encode message
  ...
  | .updateReferencePricesResponse message => UpdateReferencePricesResponse.encode message
...
theorem encode_length_le (message : ServerPayload) : (encode message).length ≤ 12593050 := by
  cases message with
  ...
  | tesExecutionBroadcast inner =>
    ...
    omega
  | tesInquireBoundaryPricesResponse inner =>
    simp only [encode, TesInquireBoundaryPricesResponse.encode_length]
    omega
  | tesResponse inner =>
  ...
  | unsubscribeResponse inner =>
    ...
    omega
  | updateReferencePricesResponse inner =>
    simp only [encode, UpdateReferencePricesResponse.encode_length]
    omega
...
def decode (tag : BitVec 16) (bytes : List UInt8) : Option ServerPayload :=
  ...
  else if tag = 10330 then (TesInquireBoundaryPricesResponse.decode bytes).bind fun (message, rest) => if rest.isEmpty then some (.tesInquireBoundaryPricesResponse message) else none
  ...
  else if tag = 10332 then (UpdateReferencePricesResponse.decode bytes).bind fun (message, rest) => if rest.isEmpty then some (.updateReferencePricesResponse message) else none
...
theorem decode_encode (message : ServerPayload) :
  ...
  | tesInquireBoundaryPricesResponse message => simp [decode, encode, tag, TesInquireBoundaryPricesResponse.decode_encode_nil]
  ...
  | updateReferencePricesResponse message => simp [decode, encode, tag, UpdateReferencePricesResponse.decode_encode_nil]
...
theorem encodeBody_length_lt (message : ServerMessage) : (encodeBody message).length + 4 < 256 ^ 4 := by
  ...
  | tesExecutionBroadcast inner =>
    ...
    omega
  | tesInquireBoundaryPricesResponse inner =>
    simp only [ServerPayload.encode, List.length_append, encodeUIntLE_length, TesInquireBoundaryPricesResponse.encode_length]
    omega
  | tesResponse inner =>
  ...
  | unsubscribeResponse inner =>
    ...
    omega
  | updateReferencePricesResponse inner =>
    simp only [ServerPayload.encode, List.length_append, encodeUIntLE_length, UpdateReferencePricesResponse.encode_length]
    omega
  | updateRemainingRiskAllowanceBaseResponse inner =>
    have bound_inner := UpdateRemainingRiskAllowanceBaseResponse.encode_length_le inner
    simp only [ServerPayload.encode, List.length_append, encodeUIntLE_length]
...
end Omi.EurexT7EtiFbeV150Server
