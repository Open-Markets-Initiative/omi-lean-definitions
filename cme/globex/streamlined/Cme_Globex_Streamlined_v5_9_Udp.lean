...
@[simp] theorem decode_encode (message : TradeBlocksLegsGroup) (rest : List UInt8) :
  ...
  rw [decodeUIntLE_encodeUIntLE, Option.bind_some]
  dsimp only
  rw [LegStrikePriceDecimal64Null.decode_encode, Option.bind_some]
  dsimp only
  rw [Alpha.decode_encode, Option.bind_some]
  dsimp only
  rw [LegUnitOfMeasureQtyDecimal64Null.decode_encode, Option.bind_some]
  dsimp only
  rw [Alpha.decode_encode, Option.bind_some]
  dsimp only
  rw [decodeUIntLE_encodeUIntLE, Option.bind_some]
...
@[simp] theorem decode_encode (message : TradeBlocksLegsGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 TradeBlocksLegsGroup.encode TradeBlocksLegsGroup.decode TradeBlocksLegsGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : TradeBlocksGroup) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode, Option.bind_some]
  dsimp only
  rw [UnitOfMeasureQtyDecimalOptional.decode_encode, Option.bind_some]
  dsimp only
  rw [decodeUIntLE_encodeUIntLE, Option.bind_some]
  dsimp only
  rw [decodeUIntLE_encodeUIntLE, Option.bind_some]
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [StrikePriceDecimalOptional.decode_encode, Option.bind_some]
  dsimp only
  rw [Alpha.decode_encode, Option.bind_some]
  dsimp only
  rw [Alpha.decode_encode, Option.bind_some]
...
@[simp] theorem decode_encode (message : TradeBlocksGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 TradeBlocksGroup.encode TradeBlocksGroup.decode TradeBlocksGroup.decode_encode, Option.bind_some]
  dsimp only
...
@[simp] theorem decode_encode (message : OtcGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt, Option.bind_some]
  dsimp only
  rw [decodeMany_bounded 1 OtcGroup.encode OtcGroup.decode OtcGroup.decode_encode, Option.bind_some]
  dsimp only
