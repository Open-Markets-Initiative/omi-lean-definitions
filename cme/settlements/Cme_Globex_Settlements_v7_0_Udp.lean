...
@[simp] theorem decode_encode (message : IncrementalRefreshSettleGroup) (rest : List UInt8) :
  ...
  rw [decodeUIntLE_encodeUIntLE]
  simp only [Option.bind_some]
  rw [FormattedLastPx.decode_encode]
  simp only [Option.bind_some]
  rw [decodeUIntLE_encodeUIntLE]
  simp only [Option.bind_some]
  rw [decodeUIntLE_encodeUIntLE]
...
@[simp] theorem decode_encode (message : IncrementalRefreshSettleGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 IncrementalRefreshSettleGroup.encode IncrementalRefreshSettleGroup.decode IncrementalRefreshSettleGroup.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : IncrementalRefreshVoiGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 IncrementalRefreshVoiGroup.encode IncrementalRefreshVoiGroup.decode IncrementalRefreshVoiGroup.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : IncrementalRefreshHighLowGroup) (rest : List UInt8) :
  ...
  rw [decodeUIntLE_encodeUIntLE]
  simp only [Option.bind_some]
  rw [LowPx.decode_encode]
  simp only [Option.bind_some]
  rw [LowPxInd.decode_encode]
  simp only [Option.bind_some]
  rw [HighPx.decode_encode]
  simp only [Option.bind_some]
  rw [HighPxInd.decode_encode]
  simp only [Option.bind_some]
  rw [decodeUIntLE_encodeUIntLE, Option.bind_some]
  rfl
...
@[simp] theorem decode_encode (message : IncrementalRefreshHighLowGroups) (rest : List UInt8) :
  ...
  rw [decodeUInt_encodeUInt]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 IncrementalRefreshHighLowGroup.encode IncrementalRefreshHighLowGroup.decode IncrementalRefreshHighLowGroup.decode_encode]
  simp only [Option.bind_some]
