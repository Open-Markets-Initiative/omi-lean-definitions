...
@[simp] theorem decode_encode (message : DeleteAllOrderBroadcast) (rest : List UInt8) :
  ...
  simp only [Option.bind_some]
  rw [decodeMany_bounded 2 AffectedOrdGrpComp.encode AffectedOrdGrpComp.decode AffectedOrdGrpComp.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : OtcUploadBroadcast) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 SideAllocOtcGrpComp.encode SideAllocOtcGrpComp.decode SideAllocOtcGrpComp.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : OverallRiskLimitsReport) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 RiskLimitTypesGrpComp.encode RiskLimitTypesGrpComp.decode RiskLimitTypesGrpComp.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : TradingActionResponse) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 MatchingEngineStatusGrpComp.encode MatchingEngineStatusGrpComp.decode MatchingEngineStatusGrpComp.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : XetraEnLightNegotiationRequesterNotification) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 XetraEnLightTargetPartiesComp.encode XetraEnLightTargetPartiesComp.decode XetraEnLightTargetPartiesComp.decode_encode]
  simp only [Option.bind_some]
