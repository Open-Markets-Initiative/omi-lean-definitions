...
@[simp] theorem decode_encode (message : ApproveBasketTradeRequest) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 BasketSideAllocExtGrpComp.encode BasketSideAllocExtGrpComp.decode BasketSideAllocExtGrpComp.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : EnterClipRequest) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 CrossRequestSideGrpComp.encode CrossRequestSideGrpComp.decode CrossRequestSideGrpComp.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 SideCrossLegGrpComp.encode SideCrossLegGrpComp.decode SideCrossLegGrpComp.decode_encode]
  simp only [Option.bind_some]
...
@[simp] theorem decode_encode (message : LogonRequest) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [ApplUsageOrders.decode_encode]
  simp only [Option.bind_some]
  rw [ApplUsageQuotes.decode_encode]
  simp only [Option.bind_some]
  rw [OrderRoutingIndicator.decode_encode]
  simp only [Option.bind_some]
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [Alpha.decode_encode]
...
@[simp] theorem decode_encode (message : PreTradeRiskLimitsDefinitionRequest) (rest : List UInt8) :
  ...
  rw [Alpha.decode_encode]
  simp only [Option.bind_some]
  rw [decodeMany_bounded 1 RiskLimitQtyGrpComp.encode RiskLimitQtyGrpComp.decode RiskLimitQtyGrpComp.decode_encode]
  simp only [Option.bind_some]
